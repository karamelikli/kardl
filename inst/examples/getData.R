...
#' # ENDE_XDC_USD_RATE   Exchange Rates, Domestic Currency per U.S. Dollar,
#'                       End of Period, Rate
#'
trdata<-IFS$get_series(freq = "M", ref_area = "TR",
...
trdata[420:470,4]<-1
KARDL_model <-KARDL(CPI~ER+PPI+asym(ER)+deterministic(covid)+trend,
                    trdata,userdefined=c(1,2,2,0))
