...
This outlines how to propose a change to kardl.
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("karamelikli/kardl", fork = TRUE)`.
